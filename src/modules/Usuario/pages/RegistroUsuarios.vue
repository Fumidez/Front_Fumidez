  ...
  <div class="page-container d-flex flex-column" style="min-height: 100vh;">
    ...
    <main class="flex-grow-1 d-flex align-items-center justify-content-center">
      <div class="card p-5 shadow-lg"
        ...
        <button type="button" class="btn btn-secondary w-100 mt-2 py-2" @click="redirigirListadoUsuario">
          Volver al listado
        </button>
        </form>
      </div>
    ...
    async submitForm() {
      try {
        if (this.esEdicion) {
          ...
          this.mensajeConfirmacion = "¡El usuario ha sido actualizado con exito!";
          this.consultarPorIdUsuario(this.usuarioId);
        } else {
          // Llama al método de creación
          const nuevoUsuario = await crearUsuarioFachada(this.usuario);
          this.mensajeConfirmacion = "¡El usuario ha sido creado con exito!";
