      ...
      <div class="card p-5 shadow-lg"
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group mb-3">
            <label for="role" class="d-flex align-items-center"><i class="bi bi-person-fill"></i> Rol del usuario</label>
            <div class="dropdown">
          ...
          <div class="form-group mb-3 d-flex align-items-center">
            <label for="contrasenia" class="w-25"><i class="bi bi-person-raised-hand"></i> Contraseña</label>
            <input type="password" id="contrasenia" v-model="usuario.contrasenia" class="form-control" placeholder="Contraseña" />
          </div>

          <!-- Nombre -->
          <div class="form-group mb-3 d-flex align-items-center">
            <label for="nombre" class="w-25"><i class="bi bi-person-fill"></i> Nombre</label>
            <input type="text" id="nombre" v-model="usuario.nombre" class="form-control" placeholder="Nombre" />
          </div>

          <!-- Correo -->
          <div class="form-group mb-3 d-flex align-items-center">
            <label for="correo" class="w-25"><i class="bi bi-envelope-at-fill"></i> Correo</label>
            <input type="email" id="correo" v-model="usuario.correo" class="form-control" placeholder="Correo" />
          </div>
          ...
          <div class="form-group mb-3 d-flex align-items-center">
            ...
            <input type="text" id="direccion" v-model="usuario.direccion" class="form-control" placeholder="Dirección" />
          </div>

          <!-- Teléfono -->
          <div class="form-group mb-3 d-flex align-items-center">
            <label for="telefono" class="w-25"><i class="bi bi-person-fill"></i> Teléfono</label>
            <input type="tel" id="telefono" v-model="usuario.telefono" class="form-control" placeholder="Teléfono" />
          </div>
